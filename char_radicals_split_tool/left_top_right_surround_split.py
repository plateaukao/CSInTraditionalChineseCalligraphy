...
def left_top_right_surround_split():
    root_path = "../../../Data/Calligraphy_database/not_process_data_split/lp"
    save_path = "../../../Data/Calligraphy_database/not_process_data_split/lp_left_top_right_surround_split"
    ...
    for i in range(len(file_names)):
        ...
        if fn_struct == "Left Top Right surrounded":
            ud_count += 1
