...
from calligraphyLayoutAnalysisTool.charactersegmentationmainwindow import Ui_MainWindow
from utils.Functions import getAllMiniBoundingBoxesOfImage, getCenterOfRectangles, combineRectangles, rgb2qimage
from calligraphyLayoutAnalysisTool.tools import filterBoxWithWidth, removeContainedBoxes
...
class CharacterSegmentationMainWindow(QMainWindow, Ui_MainWindow):
    ...
    def segmentationBtn(self):
        ...
        for i in range(len(rects)):
            ...
            self.rectangles.append((new_r_x, new_r_y, new_r_w, new_r_h))
    ...
    def extractBtn(self):
        ...
        if len(self.rectangles) == 0:
            return
        print('rect len:', len(self.rectangles))
        # save path
        fileName, _ = QFileDialog.getOpenFileName(None, "Open file", QDir.currentPath())
        print(fileName)
